...
public class AppConstants {
    ...
    public static List<String> expectedAccPageHeaderssList = new ArrayList<>(Arrays.asList("My Account",
                                                                        "My Orders",
                                                                        "My Affiliate Account",
                                                                        "Newsletter"));
    public static final String REGISTER_SUCCESS_MESSGAGE = "Your Account Has Been Created!";
